        ...
        <div className="mt-3 lg:flex gap-0">
            ...
            <div className="container mx-auto  w-full max-w-md p-8 space-y-3 rounded-xl bg-slate-200 ">
                ...
                <form
                    ...
                    <div className="space-y-1 text-sm">
                        <label htmlFor="password" className="block dark:text-gray-600">PIN</label>
                        <div className="relative ">
                            <input type='number' required name="pin" id="password" placeholder="PIN" className="w-full px-4 py-3 rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-default-600"
                                {...register("PIN")}
                            />
            ...
            <div className="flex justify-center space-x-4">
                ...
                <p className="text-xs text-center sm:px-6 dark:text-gray-600">Do not have an account? <br />
                    <Link to='/'><button className="btn mt-2 bg-slate-400">Sign Up</button></Link>
                </p>
            </div>

            <div >
                <img className='lg:w-[400px] lg:h-[300px] mt-5 lg:mt-32 rounded-lg container lg:mr-40'
                    // src={picture}
                    alt="" />
            </div>
        </div>
